...
ACFS_MANIFEST_SHA256="efceb2b003eff181a1ad27017bd4b4dacf76d75b558207f2e765c986de421a21"
...
declare -gA ACFS_MODULE_PHASE=(
  ...
  ['agents.gemini']="7"
  ['agents.opencode']="7"
  ['agents.oh_my_openagent']="7"
  ['agents.antigravity']="7"
  ['tools.vault']="8"
  ['db.postgres18']="8"
  ['cloud.wrangler']="8"
  ['cloud.supabase']="8"
...
declare -gA ACFS_MODULE_DEPS=(
  ...
  ['agents.oh_my_openagent']="lang.bun,agents.opencode"
  ['agents.antigravity']="base.system"
  ...
  ['utils.openproxy']="base.system"
  ['utils.fast_file_search']="base.system"
  ['utils.rtco']="base.system"
  ['utils.hashline']="base.system"
...
declare -gA ACFS_MODULE_FUNC=(
  ...
  ['agents.oh_my_openagent']="install_agents_oh_my_openagent"
  ['agents.antigravity']="install_agents_antigravity"
  ...
  ['utils.openproxy']="install_utils_openproxy"
  ['utils.fast_file_search']="install_utils_fast_file_search"
  ['utils.rtco']="install_utils_rtco"
  ['utils.hashline']="install_utils_hashline"
...
declare -gA ACFS_MODULE_CATEGORY=(
  ...
  ['utils.aadc']="tools"
  ['utils.caut']="tools"
  ['utils.openproxy']="tools"
  ['utils.fast_file_search']="tools"
  ['utils.rtco']="tools"
  ['utils.hashline']="tools"
  ['acfs.workspace']="acfs"
  ['acfs.onboard']="acfs"
  ['acfs.update']="acfs"
  ['acfs.nightly']="acfs"
...
declare -gA ACFS_MODULE_TAGS=(
  ...
  ['agents.oh_my_openagent']="recommended,agent,opencode-plugin"
  ...
  ['utils.openproxy']="utility,network,proxy"
  ['utils.fast_file_search']="utility,search,filesystem"
  ['utils.rtco']="utility,llm,optimizer"
  ['utils.hashline']="utility,editing,mcp"
...
declare -gA ACFS_MODULE_DESC=(
  ...
  ['agents.oh_my_openagent']="oh-my-openagent (OpenCode plugin / multi-provider config helper)"
  ...
  ['utils.openproxy']="OpenProxy - lightweight HTTP/HTTPS proxy server"
  ['utils.fast_file_search']="Fast File Search - rapid file discovery tool"
  ['utils.rtco']="rtco (Rust Token Cost Optimizer) - LLM output filter and context management for AI coding agents"
  ['utils.hashline']="hashline - stable line-addressed file editing using content-hashed anchors"
...
declare -gA ACFS_MODULE_INSTALLED_CHECK=(
  ...
  ['agents.oh_my_openagent']="test -f \"\$HOME/.config/opencode/opencode.json\" && grep -Eq 'oh-my-openagent|oh-my-opencode' \"\$HOME/.config/opencode/opencode.json\""
  ...
  ['utils.openproxy']="command -v openproxy"
  ['utils.fast_file_search']="command -v fast_file_search"
  ['utils.rtco']="command -v rtco"
  ['utils.hashline']="command -v hashline"
...
declare -gA ACFS_MODULE_INSTALLED_CHECK_RUN_AS=(
  ...
  ['agents.oh_my_openagent']="target_user"
  ['agents.antigravity']="target_user"
  ['tools.vault']="current"
  ...
  ['utils.openproxy']="target_user"
  ['utils.fast_file_search']="target_user"
  ['utils.rtco']="target_user"
  ['utils.hashline']="target_user"
